...
$show_information = $home -> show_information($user_id);

if($show_information){
    $resultInformation = $show_information -> fetch_assoc();
}
        ...
        <div className="container-fluid bg-light pt-3 pb-5" style="height: 1000px;">
                <div className="row">
                    <div className="col-8 col-md-8 border border-dark">
                        <h2 className="mt-5">Thông tin cá nhân</h2><hr>
                        <p>Họ và tên : <?php echo $resultInformation["user_name"] ?></p>
                        <p>Số điện thoại : <?php echo $resultInformation["user_phone"] ?></p>
                    </div>
                </div>
            </div>
